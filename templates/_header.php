...
<div class="aside">
	<nav>
		...
		<a class="link" href="/logout?Hi_What_are_you_looking_for=<?=_crypt(sha1(getPasswordSalt($code['a'])), 'Logout');?>"><img src="/assets/images/icons/logout.svg" class="icon">Вихід</a>
	</nav>
</div>