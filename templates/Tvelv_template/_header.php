...
<div class="aside">
	<nav>
		...
		<a class="link" href="/logout?Hi_What_are_you_looking_for=<?=sha1(getPasswordSalt($code['a']));?>"><img src="/assets/images/icons/logout.svg" class="icon">Вихід</a>
	</nav>
</div>