...
<div class="aside">
	<nav>
		...
		<a class="link" href="/logout?rnd<?=rand(10000000,99999999);?>"><img src="/assets/images/icons/logout.svg" class="icon">Вихід</a>
	</nav>
</div>