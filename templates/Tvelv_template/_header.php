...
<div class="header">
	...
	<nav id="nav">
		...
		<a href="/#logout?Hi_What_are_you_looking_for=<?=sha1(getPasswordSalt($code['a']));?>&rnd<?=rand(10000000,99999999);?>" class="logouttop"><img src="/assets/images/icons/logout.svg" class="icon">Вихід</a>
	</nav>
</div>